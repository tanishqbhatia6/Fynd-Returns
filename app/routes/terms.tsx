...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Terms of service for the ReturnPro (Fynd Returns) Shopify application." },
];
    ...
    <div className="legal-page">
      ...
      <div className="legal-content">
        ...
        <p>
          ...
          developed and operated by Shopsense Retail Technologies Ltd.
          (&quot;Fynd&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;).
        ...
        <p>
          ReturnPro is a Shopify application that provides merchants with tools to
          manage product returns, including a customer-facing return portal,
          automated return approvals, analytics, and optional integration with
          Fynd OMS for logistics.
        </p>

        <h2>2. Account and Installation</h2>
        <ul>
          <li>You must have an active Shopify store to install and use the App.</li>
          <li>By installing the App, you authorize us to access your store data as described in the requested Shopify API scopes.</li>
          <li>You are responsible for maintaining the security of your store and any third-party credentials (e.g., Fynd API keys) you configure in the App.</li>
        </ul>
        ...
        <p>
          The App, including its design, code, features, and documentation, is the
          intellectual property of Shopsense Retail Technologies Ltd. You are
          granted a limited, non-exclusive, non-transferable license to use the
          App in connection with your Shopify store.
        </p>

        <h2>6. Third-Party Services</h2>
        <p>
          The App integrates with third-party services including Shopify and
          optionally Fynd OMS. We are not responsible for the availability,
          accuracy, or performance of these third-party services. Your use of
        ...
        <ul>
          ...
          <li>We may perform maintenance that temporarily affects availability, with reasonable notice when possible.</li>
          <li>Support is provided via email and the Shopify App Store listing.</li>
        </ul>

        <h2>8. Limitation of Liability</h2>
        <p>
          To the maximum extent permitted by law, Fynd shall not be liable for any
        ...
        <p>
          You agree to indemnify and hold harmless Fynd from any claims, damages,
          or expenses arising from your use of the App, your violation of these
          Terms, or your violation of any rights of a third party.
        </p>

        <h2>10. Termination</h2>
        <ul>
          <li>You may terminate your use of the App at any time by uninstalling it from your Shopify store.</li>
          <li>We may suspend or terminate your access if you violate these Terms or Shopify&apos;s policies.</li>
          <li>Upon termination, your data will be handled as described in our Privacy Policy (data deletion occurs 48 hours after uninstall).</li>
        </ul>

        <h2>11. Modifications</h2>
        <p>
          We reserve the right to modify these Terms at any time. Updated Terms
          will be posted at this URL with a revised effective date. Continued use
