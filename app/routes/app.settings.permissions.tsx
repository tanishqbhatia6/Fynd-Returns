    ...
    <AppPage heading="Permissions" actions={actions}>
      <div className="app-content">
        ...
        <fetcher.Form id="permissions-settings-form" method="post">
          ...
          >
            Manage app permissions to control what order data can be accessed for return and refund
            processing.
          </p>
          ...
          >
            <div style={{ display: "flex", alignItems: "flex-start", gap: 16, marginBottom: 20 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  ...
                  manages the full return lifecycle — which by nature spans orders from any point in
                  time — so four specific flows need broader access:
                </p>
                <ul
                  style={{
                    fontSize: 13,
                ...
                >
                  <li>
                    <strong>Extended return windows.</strong> Merchants regularly set 90-, 180-, or
                    365-day return policies (apparel, electronics with manufacturer defects, gift
                    purchases). When a customer starts a return through the storefront portal, we
                    look up their order to verify eligibility, value, and fulfillment status.
                    Without this scope, the lookup fails for the exact orders most likely to be
                    returned under an extended policy — defeating the feature.
                  </li>
                  <li>
                    <strong>Fynd &harr; Shopify order matching.</strong> Merchants using Fynd OMS
                    receive webhooks carrying an{" "}
                    <code
                      style={{
                        fontSize: 12,
                        padding: "1px 4px",
                    ...
                    that identifies the corresponding Shopify order. Those orders can be arbitrarily
                    old — especially for merchants migrating historical data. Without this scope we
                    can't resolve legacy references, breaking reverse-logistics automation.
                  </li>
                  <li>
                    <strong>Historical analytics.</strong> The dashboard supports date ranges over
                    any window the merchant selects (This year, Last 90 days, custom). Return rate
                    and revenue-impact metrics require reading order volume over the same period —
                    so every multi-month report depends on reading historical orders.
                  </li>
                  <li>
                    ...
                    outside the window become newly eligible. Without this scope the portal would
                    wrongly reject eligible orders.
                  </li>
                </ul>
                <div
                  style={{
                ...
                >
                  ...
                  is deleted within 30 days of a{" "}
                  <code style={{ fontSize: 11 }}>customers/redact</code> webhook and all per-shop
                  data is wiped on <code style={{ fontSize: 11 }}>shop/redact</code>. This scope is
            ...
            <div
              style={{
                ...
                borderRadius: "var(--rpm-radius)",
                marginBottom: 20,
                background: data.hasReadAllOrdersScope
                  ? "var(--rpm-success-bg)"
                  : "var(--rpm-warning-bg)",
            ...
            >
              ...
              {data.hasReadAllOrdersScope ? (
                <span style={{ fontSize: 14, color: "#047857", fontWeight: 500 }}>
                  Scope is configured in your app environment
                </span>
              ) : (
                <span style={{ fontSize: 13, color: "#b45309", lineHeight: 1.5 }}>
                  ...
                  to your SCOPES environment variable and reinstall the app to enable this
                  permission.
                </span>
              )}
            </div>
