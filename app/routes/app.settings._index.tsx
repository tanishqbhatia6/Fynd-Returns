...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  try {
    ...
    const notifCount = [
      s?.notificationNewReturn,
      s?.notificationApproved,
      s?.notificationRejected,
      s?.notificationRefunded,
    ...
    const greenReturnsThreshold =
      s?.greenReturnsThreshold != null ? Number(s.greenReturnsThreshold) : 0;
    const hasDefaultReturnInstructions = !!(
      s?.defaultReturnInstructions && s.defaultReturnInstructions.trim().length > 0
    );
    ...
    return {
      ...
      bonusCreditPct,
      greenReturnsEnabled,
      greenReturnsThreshold,
      hasDefaultReturnInstructions,
      portalLanguage,
      productPolicyCount,
      ...
      cards: [
        {
          ...
          status: [
            ...
            ...(d.restrictedRegionCount > 0
              ? [
                  {
                    label: `${d.restrictedRegionCount} restricted region${d.restrictedRegionCount !== 1 ? "s" : ""}`,
        ...
        },
        {
          ...
          status: [
            ...
            d.autoApprove
              ? { label: "Auto-approve", variant: "ok" }
              : { label: "Manual approve", variant: "off" },
            d.autoRefund
              ? { label: "Auto-refund", variant: "ok" }
              : { label: "Manual refund", variant: "off" },
            ...(d.hasReturnFee
              ? [
                  {
                    label: `${d.returnFeeCurrency} ${d.returnFeeAmount} fee`,
                    variant: "info" as const,
                  },
                ]
              : []),
            ...
            {
              label:
                d.refundPaymentMethod === "store_credit"
                  ? "Store credit"
                  : d.refundPaymentMethod === "both"
                    ? "Split refund"
                    : "Original payment",
              variant: "info" as const,
            },
        ...
        },
        {
          ...
          status: [
            d.productPolicyCount > 0
              ? {
                  label: `${d.productPolicyCount} rule${d.productPolicyCount !== 1 ? "s" : ""}`,
                  variant: "ok",
                }
      ...
      cards: [
        {
          ...
          status: [
            ...
            ...(d.autoRulesCount > 0
              ? [
                  {
                    label: `${d.autoRulesCount} rule${d.autoRulesCount !== 1 ? "s" : ""}`,
                    variant: "info" as const,
                  },
                ]
              : []),
        ...
        },
        {
          ...
          status: [
            ...
            ...(d.hasFynd && d.fyndEnv
              ? [
                  {
                    label: d.fyndEnv === "prod" ? "Production" : "UAT",
                    variant: d.fyndEnv === "prod" ? ("ok" as const) : ("info" as const),
                  },
                ]
              : []),
          ],
        },
        {
          ...
          status: [
            ...
            d.notifCount > 0
              ? {
                  label: `${d.notifCount}/4 enabled`,
                  variant: d.notifCount === 4 ? ("ok" as const) : ("info" as const),
                }
        ...
        },
        {
          ...
          icon: (
            ...
            >
              ...
              <path d="M9.5 7.5L14 3l7 7-4.5 4.5" />
          ...
          status: [
            ...
            ...(d.greenReturnsEnabled && d.greenReturnsThreshold > 0
              ? [
                  {
                    label: `< ${new Intl.NumberFormat("en", { style: "currency", currency: d.shopCurrency || "USD", minimumFractionDigits: 0, maximumFractionDigits: 0 }).format(d.greenReturnsThreshold)} threshold`,
                    variant: "info" as const,
                  },
                ]
              : []),
          ...
          status: [
            {
              ...
              variant: d.portalLanguage !== "en" ? ("ok" as const) : ("info" as const),
            },
          ],
        },
        {
        ...
        <div className="settings-summary-bar">
          <div style={{ flex: 1, minWidth: 200 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              ...
              {d.autoRulesCount > 0 && (
                <MiniChip
                  label={`${d.autoRulesCount} auto-rule${d.autoRulesCount !== 1 ? "s" : ""}`}
                  variant="info"
                />
              )}
        ...
        {groups.map((group) => (
          <div key={group.title} style={{ marginBottom: 24 }}>
            <div
              ...
              style={{ marginBottom: 10, paddingLeft: 2, fontSize: 12, fontWeight: 600 }}
            >
              {group.title}
            </div>
            ...
            <div
              ...
              style={group.cards.length === 1 ? { gridTemplateColumns: "1fr" } : undefined}
            >
              {/* v8 ignore stop */}
              {group.cards.map((c, ci) => (
                ...
                >
                  ...
                  >
                    <div
                      className="app-settings-card-icon"
                      style={{
                        background: c.iconBg,
                        color: c.iconStroke,
                        width: 40,
                  ...
                  <div>
                    <div
                      className="app-settings-card-title"
                      style={{ fontSize: 14, marginBottom: 3 }}
                    >
                      {c.title}
                    </div>
                    <div
                      className="app-settings-card-desc"
