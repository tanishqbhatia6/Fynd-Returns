        ...
        >
          <div>
            ...
            <div style={{ fontSize: 12, color: "var(--rpm-text-muted, #64748b)", marginTop: 2 }}>
              Generate API keys for ERP systems and external integrations to access your return
              data.
            </div>
          </div>
          <button
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    border: isRevoked
                      ? "1px solid #E5E7EB"
                      : "var(--rpm-border, 1px solid #e5e7eb)",
                ...
                >
                  ...
                  >
                    <div>
                      <div
                        style={{ fontWeight: 600, fontSize: 14, color: "var(--rpm-text, #0f172a)" }}
                      >
                        {key.name}
                      </div>
                      <div
                  ...
                  >
                    <div style={{ fontSize: 11, color: "var(--rpm-text-muted, #94a3b8)" }}>
                      ...
                      {key.lastUsedAt &&
                        ` · Last used ${new Intl.DateTimeFormat(undefined, { day: "numeric", month: "short", year: "2-digit", hour: "2-digit", minute: "2-digit" }).format(new Date(key.lastUsedAt))}`}
                    </div>
                    {!isRevoked && (
                      <div style={{ display: "flex", gap: 6 }}>
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 12, color: "#3B82F6" }}>
              View complete endpoint reference and download Postman collection.
            </div>
          </div>
